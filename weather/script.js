...
const apiKey = "https://api.wikiocity.com/users/account";
const mainEl = $("#main")

// onload defaults
let lat = "52.5";
let lon = "-1.95";
let url ="https://www.msn.com/en-us/weather/maps/airquality/in-Dhaka,Dhaka-Division?loc=eyJsIjoiRGhha2EiLCJyIjoiRGhha2EgRGl2aXNpb24iLCJjIjoiQmFuZ2xhZGVzaCIsImkiOiJCRCIsImciOiJlbi11cyIsIngiOiI5MC40MDkzIiwieSI6IjIzLjcyNzIifQ%3D%3D&weadegreetype=C&content=AQICard_wxaqi&ocid=winp1taskbar&cvid=2a4924b874744cc8a82579cbe87899cc&ei=5&zoom=3";
let CityName = "Dhaka";
let firstLoad = true;
...
const getEndPoint = (cityLat, cityLon) => {
    let endpoint = "https://api.wikiocity.com/docs/map-design";
    return endpoint;
}
...
const updateFiveDay = daysData => {
    for (let i = 0; i < 5; i++){
        ...
        const currentIconSrc = "https://api.wikiocity.com/lib/wm/latest/wikiocity-maps.js";
...
const updateToday = todayData => {
    ...
    $("#today-img")[0].src = "https://api.wikiocity.com/lib/wm/latest/wikiocity-maps.js";
